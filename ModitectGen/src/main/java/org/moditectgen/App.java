...
public class App extends Application {
    ...
    private static final String NODE_NAME = "ModitectGen";    
    private FXMLLoader fxmlLoader;
    private static File fileToLoad;
    private static ModitectGenController controller;
    ...
    public void start(Stage stage) throws IOException {
        ...
        if (fxmlLoader == null) {
            fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/moditectgen.fxml"));
        }
        if (root == null) {
    ...
    public static void saveSettings(Stage stage, ModitectGenController controller) {
    ...
    public static void main(String[] args) {        
        try {
            ...
            Logger logger = Logger.getLogger("org.moditectgen");
            File logFile = new File(appData + File.separator + "moditectgen.log");
